...
## Instructions
1. **Read Requirements**: Carefully analyze the user's natural language input and ensure you have the **Requirement ID** provided by the orchestrator.
...
4. **Output**: Create a file named `requirement-{RequirementID}.md` in the `/docs/1-requirements/` directory.
