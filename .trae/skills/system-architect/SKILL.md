...
## Instructions
1. **Input**: Read the PRD (`/docs/1-requirements/`) and Design (`/docs/2-design/`).
2. **Apply Standards**:
   - API formatting: [规范-API接口定义.md](../../../规范-API接口定义.md).
   - Tech Stack: [规范-技术栈&系统环境.md](../../../规范-技术栈&系统环境.md).
3. **Lock Intent**:
...
4. **Output**: Create a file named `API_[ProjectName].md` in the `/docs/3-api/` directory.
